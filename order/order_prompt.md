...
このチャットで行われた作業が、全て下記資料に反映されているかをチェック。
資料と差異があった場合は、現在の実装をチェックし、正しい状態に保つこと。
ただし差異があった場合でも、このチャット以外で作業を行った可能性があるため、必ず実装＝正として確認すること。
なおリビジョンはカウントアップせず、更新内容は最新のリビジョンに追記すること。
D:\ozlab\phaseout\PROJECT_ARCHITECTURE.md
D:\ozlab\phaseout\PROJECT_FUNCTION_INDEX.md
