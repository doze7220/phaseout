...
| SoundManager#getProcessedVisualizerData | - | ranges, size, step | Array | title-animation.js, Visualizer.js | 描画毎等 | なし | 抽出したFFTデータを帯域ごとにEQカーブ補正・動的Threshold適用・スムージング処理し、視覚用の描画データ配列を生成する。 |
