...
export const AUDIO_ASSETS = {
    STAGE_BGM_SETS: {
        SET_01: {
            ...
            phase_break: { src: 'assets/sound/bgm/Digi_Rock_03.mp3', volume: 1.2 }
        }
        /*
        SET_01: {
    ...
    SE: {
        ...
        GUN: [
            { src: 'assets/sound/se/maou_se_battle_gun01.mp3', volume: 0.8 },
            { src: 'assets/sound/se/maou_se_battle_gun02.mp3', volume: 0.8 },
            { src: 'assets/sound/se/maou_se_battle_gun03.mp3', volume: 0.8 }
        ],
